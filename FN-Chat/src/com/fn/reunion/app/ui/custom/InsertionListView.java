...
package com.fn.reunion.app.ui.custom;
...
public class InsertionListView extends ListView {
    ...
    private static final int NEW_ROW_DURATION = 5000;
     ...
     */
    public void addRow(MMessage newObj) {

        final AwesomeAdapter adapter = (AwesomeAdapter)getAdapter();
        ...
        observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            public boolean onPreDraw() {
                ...
                final ImageView imgView = (ImageView)newCell.findViewById(R.id.chat_thumb);
                ...
                if (shouldAnimateInNewRow) {
                    ...
                    TextView textView = (TextView)newCell.findViewById(R.id.message_time);
                    ...
                    if (shouldAnimateInImage) {
                        ...
                        //MMessage obj = mData.get(0);
                       // Bitmap bitmap = AwesomeAdapter.getCroppedBitmap(BitmapFactory
    ...
    public void setData(List<MMessage> data) {
        mData = data;
    }
