...
public class DefualtFriendsTask extends AsyncTask<String, String, String> {
	...
	public DefualtFriendsTask(Context contextGiven, TaskDelegate delegate) {
	...
	protected String doInBackground(String... params) {
		...
		listParams.add(new BasicNameValuePair(Constants.KEY_LAST_NAME, params[3]));
